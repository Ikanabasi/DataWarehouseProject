/* 
Script Purpose:
This script cleans and transforms the data in the bronze layer and loads it into the silver layer
Run this script to redefine the structure of the silver layer
*/
